...
public class Estanque {
	...
	public Estanque(int numero, int profundidad, int superficie, int proCañeriaDer) {
	...
	private int calcularProfundidadMaximaACargar() {
		...
		//Si el nivel del agua está sobre la cañería mas alta, cargar hasta la superficie
	...
	public int llenarEstanque(int volAgua) {
		...
		int excedente = profundidadMaxima - profundidadACargar;
